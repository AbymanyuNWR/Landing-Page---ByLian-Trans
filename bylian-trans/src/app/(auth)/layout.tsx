...
export default function AuthLayout({
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row">
            <div className="w-full md:w-1/2 p-6 md:p-12 flex flex-col justify-center items-center relative z-10 bg-white shadow-[0_0_40px_-15px_rgba(0,0,0,0.1)] shrink-0 transition-all duration-500">
            ...
            <div className="hidden md:block md:w-1/2 relative overflow-hidden bg-slate-900 group">
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?q=80&w=1000&auto=format&fit=crop')] bg-cover bg-center opacity-40 mix-blend-overlay transition-transform duration-1000 group-hover:scale-105" />
